            ...
            <div class="container">
                <div class="row w-100 gx-0 gy-0 justify-content-center">
                    <form action="<?php echo home_url(); ?>/test/" method="post"
                          class="col-10 bg-light shadow-lg p-5 border border-danger rounded">
                        <h1>Login</h1>
                        <?php
                        if ($_GET["message"]):
                            ?>
                        ...
                        <div class="input-group row gy-0 gx-0 mb-3 w-100">
                            <div class="col-4 text-center  input-group-text" id="<?= __('user_login'); ?>">
                                Email/Username
                            </div>
                            <input type="text" id="<?= __('user_login'); ?>" name="username" class="col-8 form-control"
                        ...
                        <div class="input-group row gx-0 gy-0 mb-3 w-100">
                            ...
                            <input type="password" name="password" id="<?= __('user_pass'); ?>"
                                   class="col-8 form-control" placeholder="Password" aria-label="Password"
